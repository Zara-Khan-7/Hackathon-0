...
## Purpose
Draft a sales/thought-leadership post for LinkedIn, Facebook, Instagram, or Twitter/X for review and approval before publishing.
...
When the task specifies a platform other than LinkedIn, adapt the content:

| Platform | Max Length | Style | Hashtags | MCP Tool |
|----------|-----------|-------|----------|----------|
| LinkedIn | 1300 chars | Professional, storytelling | 3-5 | N/A (Playwright) |
| Facebook | ~2000 chars | Conversational, link-friendly | 2-3 | post_facebook |
| Instagram | ~2200 chars | Visual, emoji-ok, engaging | 5-15 | post_instagram |
| Twitter/X | 280 chars | Punchy, concise, thread-ok | 2-3 | post_twitter |

For non-LinkedIn platforms, use the `generate_social_post` skill and the **ai-employee-social** MCP server for drafting.

## Rules
- Professional, concise tone — matches Company Handbook guidelines.
- Never publish directly — always route through approval on ALL platforms.
- Adapt length and style per platform (see table above).
