...
def main():
    parser = argparse.ArgumentParser(description="AI Employee Orchestrator — Platinum Tier")
    ...
    parser.add_argument("--role", choices=["cloud", "local", "gold"], default="gold",
                        help="Agent role: cloud (draft-only), local (full), gold (legacy)")
